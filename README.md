# Pre-work - *My Markdown Blog*

**My Markdown Blog** is a Ruby on Rails blog application.
...
* [ ] There is a "navbar" that is responsive to window size similar to [this](http://v4-alpha.getbootstrap.com/examples/navbar/).
